      ...
      <a-card class="box-card">
        <a-carousel slot="cover" autoplay>
          <div>
            <img
              ...
              src="https://wc-project.oss-cn-shanghai.aliyuncs.com/bg.jpg"
              alt=""
            />
          </div>
          <div>
            <img
              style="height: 250px; width: 100%"
              src="https://wc-project.oss-cn-shanghai.aliyuncs.com/hd-wallpaper-g2d3f42e81_1920.jpg"
              alt=""
            />
          </div>
          <div>
            <img
              style="height: 250px; width: 100%"
              src="https://wc-project.oss-cn-shanghai.aliyuncs.com/tree-736885.jpg"
              alt=""
            />
          </div>
          <div>
            <img
              style="height: 250px; width: 100%"
              src="https://wc-project.oss-cn-shanghai.aliyuncs.com/orion-nebula-11107.jpg"
              alt=""
            />
          </div>
        </a-carousel>
        ...
        <div class="ProfileHeader-wrapper">
          <div class="ProfileHeader-main">
            <div
              class="ProfileHeader-avatar UserAvatarEditor"
              style="top: -90px"
            >
            ...
            <div class="ProfileHeader-content">
              ...
              <div class="ProfileHeader-contentBody"></div>
    ...
    <div class="Profile-main">
      ...
      <div class="css-1qyytj7 Profile-sideColumn">
        <div class="css-19idom">
          <div class="Card">
            <div
              class="ProfileSideCreator-creatorEntranceHint CreatorEntrance-hint"
            >
              <a-icon
                type="edit"
    ...
    <a-modal v-model="dialogFormVisible" title="编辑个人资料" on-ok="handleOk">
      ...
      <div class="edit-item">
        ...
        <span class="edit-button"
          ><a-button type="link" shape="circle" icon="edit" style="width: 10px"
        /></span>
      </div>
      <div class="edit-item">
        <span>年龄</span>
