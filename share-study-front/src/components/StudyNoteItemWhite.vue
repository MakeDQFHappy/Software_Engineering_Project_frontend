<template>
  ...
  import {chargePoints,like,cancelLike} from "@/api/studyNotes"
  export default {
    props: ["note"],
    methods: {
      like() {
  ...
  .css-wpffuk-layer1-RowWrapper-QuestionRowWrapper {
    ...
    padding: 16px;
    box-shadow: 0 1px 2px rgb(255, 255, 255), 0 1px 0px rgb(76, 74, 74);
    transition: box-shadow 0.0s ease-in-out 0s;
    margin-bottom: 10px;
